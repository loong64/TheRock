...
#   docker buildx build --file dockerfiles/build_manylinux_loongarch64.Dockerfile dockerfiles/
...
FROM ghcr.io/loong64/manylinux_2_38_loongarch64:2025.11.23-1
...
RUN ./install_ccache.sh "4.12.2" && rm -rf /install-ccache
...
ENV LIBRARY_PATH="/opt/rh/gcc-toolset-14/root/usr/lib64:/opt/rh/gcc-toolset-14/root/usr/lib:${LIBRARY_PATH}"
ENV LD_LIBRARY_PATH="/opt/rh/gcc-toolset-14/root/usr/lib64:/opt/rh/gcc-toolset-14/root/usr/lib:${LD_LIBRARY_PATH}"
